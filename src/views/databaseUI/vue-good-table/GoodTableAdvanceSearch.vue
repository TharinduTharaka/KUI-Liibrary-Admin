<template>
  ...
  <b-card>
    ...
    <b-sidebar
        ...
        shadow
    >
      <sidebar-content title="Edit" :id="this.edit_id"  :edit_title="this.edit_title" :edit_url="this.edit_url" :edit_cover="this.edit_cover" :edit_description="this.edit_description""/>
    </b-sidebar>
          ...
          <b-card>
            ...
            <div class="demo-inline-spacing">
              ...
              <b-button
                  ...
                  size="sm"
                  @click="edit(row.item.id,row.item.title, row.item.url, row.item.description, items[row.index].cover_photo )"
...
export default {
  ...
  methods: {
    ...
    edit(val,title, url, description, cover) {
